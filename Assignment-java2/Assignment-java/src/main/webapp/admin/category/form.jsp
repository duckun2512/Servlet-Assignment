...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-plus-square-o" aria-hidden="true"></i> Category Form</b></h5>
    </header>
    ...
    <div class="w3-padding w3-margin-bottom">
        ...
        <form action="/admin/category/create" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
